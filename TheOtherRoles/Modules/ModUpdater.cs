    ...
    public class ModUpdater { 
        ...
        public static async Task<bool> checkForUpdate() {
            try {
                ...
                var response = await http.GetAsync(new System.Uri("https://api.github.com/repos/SonOfMars90/TheOtherRoles/releases/latest"), HttpCompletionOption.ResponseContentRead);
