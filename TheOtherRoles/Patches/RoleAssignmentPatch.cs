...
namespace TheOtherRoles.Patches {
    ...
    class SetInfectedPatch
    {
        ...
        private static RoleAssignmentData getRoleAssignmentData() {
            ...
            impSettings.Add((byte)RoleId.Chamaleon, CustomOptionHolder.chamaleonSpawnRate.getSelection());
            impSettings.Add((byte)RoleId.BadGuesser, CustomOptionHolder.badGuesserSpawnRate.getSelection());
            impSettings.Add((byte)RoleId.TwoFace, CustomOptionHolder.twoFaceSpawnRate.getSelection());
            ...
            crewSettings.Add((byte)RoleId.Witch, CustomOptionHolder.witchSpawnRate.getSelection());
            crewSettings.Add((byte)RoleId.NiceGuesser, CustomOptionHolder.niceGuesserSpawnRate.getSelection());
